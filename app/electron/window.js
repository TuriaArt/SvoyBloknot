...
const I18N_BASE = {
    "en": {
        ...
        selectBtn: "Select",
        lang: "🌐 Language",
        langDesc: "User interface language, which can be switched later in <kbd>Settings</kbd> - <kbd>Appearance</kbd>. Only English and Russian are bundled — other languages can be downloaded from <a href=\"https://github.com/TuriaArt/SvoyBloknot/tree/master/app/appearance/langs\" target=\"_blank\">GitHub</a>",
    ...
    "ru": {
        ...
        selectBtn: "Выбрать",
        lang: "🌐 Язык",
        langDesc: "Язык интерфейса пользователя, который можно переключить позже в <kbd>Настройках</kbd> - <kbd>Внешний вид</kbd>. В комплекте только английский и русский — остальные языки можно скачать на <a href=\"https://github.com/TuriaArt/SvoyBloknot/tree/master/app/appearance/langs\" target=\"_blank\">GitHub</a>",
